...
class VariableService():
    ...
    def update(self, variables):
        ...
        print(f"Updating variables in {self._variable_key}")
    ...
    def has_variables(self):
        ...
        print(f"Checking if variables exist in {self._variable_key}")
        with self.connection() as conn:
    ...
    def get_variables(self, keys=None):
        ...
        print(f"Getting variables from {self._variable_key}")
